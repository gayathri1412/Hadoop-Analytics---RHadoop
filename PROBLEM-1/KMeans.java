...
public class KMeans extends Configured implements Tool
{
    ...
    public static boolean stopIteration(Configuration conf) throws IOException //called in main
    {
        ...
        Path pervCenterFile=new Path("/home/kmeans-customized");
        Path currentCenterFile=new Path("/user/newCentroid/part-r-00000");
    ...
    public int run(String[] args) throws Exception 
    {
        ...
        FileInputFormat.setInputPaths(job, "/home/kmeans");
        Path outDir=new Path("/user/newCentroid");
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        Path dataFile=new Path("/home/kmeans-customized");
        ...
        FileInputFormat.setInputPaths(job, "/home/kmeans");
        Path outDir=new Path("/user/kfinal");
        fs.delete(outDir,true);
        FileOutputFormat.setOutputPath(job, outDir);
